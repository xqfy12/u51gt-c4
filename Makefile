...
#-----------------------------------------------------------------------------
vendor_saved_apps := MtkBt EngineerMode EngineerModeSim SchedulePowerOnOff
...
#-----------------------------------------------------------------------------
vendor_modify_jars := framework mediatek-framework mediatek-telephony-common pm secondary-framework services telephony-common
