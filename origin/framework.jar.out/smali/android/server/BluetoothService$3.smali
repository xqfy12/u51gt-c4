...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v6}, Landroid/server/BluetoothService;->access$1100(Ljava/lang/String;)V
    ...
    invoke-static {v6}, Landroid/server/BluetoothService;->access$1200(Landroid/server/BluetoothService;)Landroid/server/BluetoothAdapterStateMachine;
    ...
    .line 2097
    invoke-static {v9}, Landroid/server/BluetoothService;->access$1302(Ljava/lang/String;)Ljava/lang/String;

    .line 2098
    iget-object v6, p0, Landroid/server/BluetoothService$3;->this$0:Landroid/server/BluetoothService;

    #setter for: Landroid/server/BluetoothService;->mDockPin:Ljava/lang/String;
    invoke-static {v6, v9}, Landroid/server/BluetoothService;->access$1402(Landroid/server/BluetoothService;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Landroid/server/BluetoothService;->access$1300()Ljava/lang/String;
    ...
    invoke-static {v6}, Landroid/server/BluetoothService;->access$1500(Landroid/server/BluetoothService;)Landroid/os/Handler;
