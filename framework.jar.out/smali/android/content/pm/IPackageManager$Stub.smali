...
.field static final TRANSACTION_addPermissionAsync:I = 0x50
...
.field static final TRANSACTION_checkAPKSignatures:I = 0x5c
...
.field static final TRANSACTION_chmodSkins:I = 0x4c
...
.field static final TRANSACTION_doStorePhoneUseTime:I = 0x64

.field static final TRANSACTION_enforceDexOpt:I = 0x47

.field static final TRANSACTION_enterSafeMode:I = 0x42

.field static final TRANSACTION_executeMyOrders:I = 0x4b

.field static final TRANSACTION_extendVerificationTimeout:I = 0x58
...
.field static final TRANSACTION_getAppleStyle:I = 0x49
...
.field static final TRANSACTION_getInstallLocation:I = 0x52
...
.field static final TRANSACTION_getPhoneUseTimeUp:I = 0x65
...
.field static final TRANSACTION_installExistingPackage:I = 0x56

.field static final TRANSACTION_installPackage:I = 0x29

.field static final TRANSACTION_installPackageWithVerification:I = 0x53

.field static final TRANSACTION_installPackageWithVerificationAndEncryption:I = 0x55

.field static final TRANSACTION_installPackageWithVerificationAndEncryptionWithPackageName:I = 0x54

.field static final TRANSACTION_isFirstBoot:I = 0x5a

.field static final TRANSACTION_isOnlyCoreApps:I = 0x5b
...
.field static final TRANSACTION_movePackage:I = 0x4f

.field static final TRANSACTION_nextPackageToClean:I = 0x4e
...
.field static final TRANSACTION_remountSystemRo:I = 0x60

.field static final TRANSACTION_remountSystemRw:I = 0x61

.field static final TRANSACTION_removeAllChivinApk:I = 0x62

.field static final TRANSACTION_removeChivinApk:I = 0x63
...
.field static final TRANSACTION_setAppleStyle:I = 0x4a
...
.field static final TRANSACTION_setInstallLocation:I = 0x51
...
.field static final TRANSACTION_updateExternalMediaStatus:I = 0x4d

.field static final TRANSACTION_verifyPendingInstall:I = 0x57
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 1101
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->getAppleStyle()Z
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->setAppleStyle(Z)Z
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->executeMyOrders(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->chmodSkins(Ljava/lang/String;)Z
    ...
    .line 1270
    .local v6, _arg2:Landroid/content/pm/IPackageInstallObserver;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1281
    .local v9, _arg5:Landroid/content/pm/VerificationParams;
    :goto_3d
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1287
    invoke-virtual/range {v3 .. v10}, Landroid/content/pm/IPackageManager$Stub;->installPackageWithVerificationAndEncryptionWithPackageName(Landroid/net/Uri;Ljava/lang/String;Landroid/content/pm/IPackageInstallObserver;ILjava/lang/String;Landroid/content/pm/VerificationParams;Landroid/content/pm/ContainerEncryptionParams;)V
    ...
    .end local v4           #_arg0:Landroid/net/Uri;
    .end local v5           #_arg1:Ljava/lang/String;
    .end local v6           #_arg2:Landroid/content/pm/IPackageInstallObserver;
    .end local v7           #_arg3:I
    .end local v8           #_arg4:Ljava/lang/String;
    .end local v9           #_arg5:Landroid/content/pm/VerificationParams;
    .end local v10           #_arg6:Landroid/content/pm/ContainerEncryptionParams;
    :cond_3b
    const/4 v4, 0x0
    ...
    .line 1278
    .restart local v5       #_arg1:Ljava/lang/String;
    .restart local v6       #_arg2:Landroid/content/pm/IPackageInstallObserver;
    .restart local v7       #_arg3:I
    .restart local v8       #_arg4:Ljava/lang/String;
    :cond_3c
    const/4 v9, 0x0

    .restart local v9       #_arg5:Landroid/content/pm/VerificationParams;
    goto :goto_3d
    ...
    .line 1431
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->remountSystemRo()V
    ...
    .line 1438
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->remountSystemRw()V
    ...
    .line 1445
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->removeAllChivinApk()V
    ...
    invoke-virtual {v0, v4}, Landroid/content/pm/IPackageManager$Stub;->removeChivinApk(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v11, v12}, Landroid/content/pm/IPackageManager$Stub;->doStorePhoneUseTime(J)V
    ...
    .line 1470
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/IPackageManager$Stub;->getPhoneUseTimeUp()I
